...
#### academic history
#xelatex tmperry_supplemental.tex ;
#xelatex tmperry_supplemental.tex ;
#xelatex tmperry_supplemental.tex ;
##xelatex tmperry_academichistory.tex ;
##xelatex tmperry_academichistory.tex ;
##convert -alpha remove -alpha off -background white -density 500 tmperry_academichistory.pdf tmperry_academichistory.png ;
#open  tmperry_supplemental.pdf ;
